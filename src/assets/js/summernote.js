...
(function (factory) {
    ...
    var settings = {
        ...
        options: {
            ...
            // fontName
            fontNames: [
                'Arial', 'Arial Black', 'Janna Bold', 'Comic Sans MS', 'Courier New',
                'Helvetica Neue', 'Impact', 'Lucida Grande',
                'Tahoma', 'Times New Roman', 'Verdana', 'Janna Regular'
            ], 
    ...
    var Renderer = function () {
        ...
        var tplButtonInfo = {
            ...
            color: function (lang) {
                ...
                var dropdown = '<ul class="dropdown-menu" style="position: inherit;">' +
                    '<li>' +
                    '<div class="btn-group">' +
