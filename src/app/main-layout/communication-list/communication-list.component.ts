...
import { CommunicationlistService } from './communication-list.service';
import 'jquery';
@Component({
  ...
  styleUrl: './communication-list.component.scss'
})
export class CommunicationListComponent {
  ...
  titlesearch:string='';
  constructor(private router: Router,private service:CommunicationlistService,public sharedService: SharedService, private titleService: Title,private snackbar:SnackbarService) {
    this.titleService.setTitle("Leaders Development Mission - Communication");
}
